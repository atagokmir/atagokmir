...
<p align="center">
  ...
  Embedded Systems · FPGA · IoT · Python · C/C++
</p>
...
- 🎓 Dual major in **Industrial Engineering** and **Computer Engineering** at MEF University
- 🏭 Interned at **Coca-Cola İçecek** and **Horoz Demir** as Production Engineer
- 🔬 Working on my **senior thesis** — Digital Twin development for flexible job shop scheduling using CP-SAT optimization
- 🔌 Currently learning **FPGA development** with Sipeed Tang Nano 9K (Gowin EDA, Verilog)
- ⚡ Passionate about **microcontrollers**, **embedded systems**, and **electronics circuit design**
- 🌱 Always building something with ESP32, ESP8266 or whatever I can get my hands on
...
|---------|-------------|--------|
| [Basic-FPGA-Projects](https://github.com/atagokmir/Basic-FPGA-Projects) | Verilog examples on Tang Nano 9K | 🔨 Active |
| Senior Thesis | Digital Twin for flexible job shop scheduling | 🔨 Active |
| 8-bit CPU | Custom multi-cycle CPU in Verilog | 🔜 Planned |
